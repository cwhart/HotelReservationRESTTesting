...
import com.lmig.model.Reservation;
import com.lmig.model.RoomViewModel;
...
public class RoomRestTest extends FunctionalTest {
    ...
    public void validRoomNumber() {
        ...
        given().when().get("/room/retrieve/101").then()
                .body(matchesJsonSchemaInClasspath("com/lmig/jsonSchemas/room-schema.json"))
    ...
    public void testSaveCreateCancelReservation() {
        ...
        Reservation model = request.post("reservation/saveCreate")
                .then().statusCode(200)
